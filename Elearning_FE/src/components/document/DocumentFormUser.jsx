...
class DocumentFormUser extends Component {
  form = createRef();
  ...
  handlePriceChange = (value) => {
    this.setState({
      showTyleFields: value > 0, // Show fields only if the price is greater than 0
    });
  };
