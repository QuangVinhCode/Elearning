...
import { newGmailOpt } from "../redux/actions/accountAction";
      ...
      <Col>
        ...
        {!showResendMessage ? (
          ...
          <div style={{ textAlign: "center", marginTop: "20px" }}>
            ...
            <Button type="primary" onClick={() => navigate("/users/profile/accountsettings")}>
              Quay lại
            </Button>
          </div>
        )}
...
export default connect(null, mapDispatchToProps)(OtpNewGmail);
